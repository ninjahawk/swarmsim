...
69 findings documented — full evidence and figures: [`findings.md`](findings.md)
...
|--------|-------|------------------------|
| `predator/` | predator strategies, encirclement, fragmentation, reunion, sensing, adaptive radius, prey fatigue, predictive encirclement (F5–F16, F19, F21–F22, F28, F31–F35, F53, F66–F69) | `encirclement_scaling.py`, `adaptive_encirclement.py`, `fragmentation.py`, `long_encirclement.py`, `fatigue.py` |
