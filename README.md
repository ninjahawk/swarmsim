...
87 findings documented — full evidence and figures: [`findings.md`](findings.md)
...
| `evolution/` | co-adaptation — heritable per-agent escape weight under capture/removal selection vs the predictive predator; the F70 valley as an evolutionary brake (F87). Builds on the validated `vectorized_predator.py` + `vectorized_predator_prey.py` harness. | `escape_evolution.py` |
...
| `findings.md` | Running notes on all 87 findings with figures |
