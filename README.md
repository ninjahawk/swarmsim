...
| `collective/` | collective decision-making — informed-minority leadership, conflicting leaders, compromise vs consensus (F72–F73; `leadership.py` lives at root) | `conflicting_leaders.py` |
